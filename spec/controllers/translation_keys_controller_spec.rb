	...
	before(:each) do
 	...
 	describe "POST update_translation" do
 	  it "should assigns @translation & render nothing" do
 	  	post :update_translation, translation_key_id: translation_key.id, format: :json, use_route: "translation_center"
 	  	  expect(assigns(:translation_key)).to eq translation_key
 	  	  expect(response.body).to be_blank
 	  end
 	  it "should assigns @translation & render json" do
 	  	post :update_translation, translation_key_id: translation_key.id, value: "value value", format: :json, use_route: "translation_center"
 	  	  expect(assigns(:translation_key)).to eq translation_key
 	  end
 	end
	...
	describe "GET translations" do
 	  it "should assigns @translations sorted by votes & render translations.js" do
		...
		# FactoryGirl.create(:translation, value: "value", translation_key: translation_key)
 	  	get :translations, translation_key_id: translation_key.id, sort_by: "votes", format: :js, use_route: "translation_center"
 	  ...
 	  it "should assigns @translations sorted by created_at" do
 	  	FactoryGirl.create(:translation, translation_key: translation_key)
 	  	get :translations, translation_key_id: translation_key.id, format: :js, use_route: "translation_center"
 	  	expect(assigns(:translations).first.class.name).to eq "TranslationCenter::Translation"
 	  end
 	end
 	...
 	describe "GET show" do
  	  it "should assign @translation_key & render show" do
  	  	get :show, id: translation_key.id, use_route: "translation_center"
  	  	expect(assigns(:translation_key)).to eq translation_key
  	...
  	describe "PUT update" do
  	  it "should assign @translation_key" do
  	  	put :update, id: translation_key.id, format: :json, use_route: "translation_center"
  	  	expect(assigns(:translation_key)).to eq translation_key
  	  ...
  	  it "should assign @translation_key & update value" do
  	  	put :update, id: translation_key.id, format: :json, value: "new value", use_route: "translation_center"
  	  	expect(assigns(:translation_key)).to eq translation_key
  	...
  	describe "POST destroy" do
  	  it "should assign translation & render destroy.js" do
  	  	delete :destroy, id: translation_key.id, format: :js, use_route: "translation_center"
  	   ...
  	   it "should assign render categories/show.html" do
  	  	delete :destroy, id: translation_key.id, use_route: "translation_center"
      ...
      describe "GET search" do
        it "should assign translations & render search" do
          get :search, search_key_name: translation_key.name, use_route: "translation_center"
          expect(assigns(:translation_key)).to eq translation_key
          expect(response).to redirect_to(translation_key)
        end

         it "should render search.js" do
          get :search, query: " ", format: :json, use_route: "translation_center"
