	...
	before(:each) do
  	...
  	describe "POST vote" do
  	  it "should assign translation & render vote.js" do
  	  	post :vote, translation_id: translation.id, format: :js, use_route: "translation_center"
  	...
  	describe "POST unvote" do
  	  it "should assign translation & render unvote.js" do
  	  	post :unvote, translation_id: translation.id, format: :js, use_route: "translation_center"
  	  	expect(assigns(:translation)).to eq translation
  	 ...
  	 describe "POST accept" do
  	  it "should assign translation & render accepted.js" do
  	  	post :accept, translation_id: translation.id, format: :js, use_route: "translation_center"
  	  	expect(assigns(:translation)).to eq translation
  	...
  	describe "POST unaccept" do
  	  it "should assign translation & render unaccept.js" do
  	  	post :unaccept, translation_id: translation.id, format: :js, use_route: "translation_center"
  	  	expect(assigns(:translation)).to eq translation
  	  	translation.reload
  	...
  	describe "POST destroy" do
  	  it "should assign translation & render destroy.js" do
  	  	delete :destroy, id: translation.id, format: :js, use_route: "translation_center"
  	  	expect(assigns(:translation)).to eq translation
  	...
  	describe "GET search" do
  	  it "should assign translations & render search" do
  	  	get :search, translation_value: "a", use_route: "translation_center"
  	   ...
  	   it "should render search.js" do
  	  	get :search, translation_value: "a",format: :js, use_route: "translation_center"
	      	expect(response).to render_template(:search)
  	  end
  	end
  end
